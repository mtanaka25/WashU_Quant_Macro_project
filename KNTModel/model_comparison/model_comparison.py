...
def compare_irfs(ARM,
    ...
    data1 = [H_share_1, ave_a_1, ave_rm_1, ave_Pd_1, ave_Pp_1, gini_a_1, gini_rm_1, gini_Pp_1, gini_Pp_1]
    data2 = [H_share_2, ave_a_2, ave_rm_2, ave_Pd_2, ave_Pp_2, gini_a_2, gini_rm_2, gini_Pp_2, gini_Pp_2]
    ...
    for i in range(len(data1)):
        ...
        multiple_line_plot(T_vec[0:T_max+2], data2plot,
                           x_label = 'periods', title = titles[i],
